...
pub mod types {
    ...
    #[derive(Clone, Debug, serde::Serialize, serde::Deserialize)]
    #[proto_message]
    pub struct ActivationTime(pub u64);
    ...
    #[proto_message]
    pub enum BeAction {
        TradeCallback(TradeStateUpdate),
        TradeEvent(ConfirmState),
        OrderEvent(TokenLimitOrders),
        Ping(Ping),
        Pong(Pong),
    }
    ...
    pub struct BurnEventData {
        pub amount: SolanaLamports,
        pub left: SolanaLamports,
    }
    ...
    pub enum CtUpdateField {
        ConfigLimits(bool),
        LeftBuys(u8),
        BuyMode(CopyTradeBuyMode),
        SellMode(CopyTradeSellMode),
        BuyAmountFixed(QuoteLamports),
        BuyAmountPerc(UD128),
        SellAmountFixed(QuoteLamports),
        SellAmountPerc(UD128),
        TxnProcBuy(TxnProcessors),
        TxnProcSell(TxnProcessors),
        LimitOrders(ApiOrders),
        Wallets(ConfigPubkeys),
        BuyBlackList(ConfigPubkeys),
        SellBlackList(ConfigPubkeys),
        BuyBlacklistSwitch(bool),
        SellBlacklistSwitch(bool),
        Name(::proto_rs::alloc::string::String),
        MinMcap(UD128),
        MaxMcap(UD128),
        BuySlippage(UD128),
        BuyTip(Lamports),
        BuyFee(Lamports),
        MaxSlotLatencyBuy(u8),
        SellSlippage(UD128),
        SellTip(Lamports),
        SellFee(Lamports),
        MaxSlotLatencySell(u8),
        IsOn(bool),
        BuyMigrationFilter(CtMigrationFilter),
        SellMigrationFilter(CtMigrationFilter),
        FollowBuys(FollowSwaps),
        FollowSells(FollowSwaps),
        PumpMayhem(bool),
        Pump(bool),
        RayAmm(bool),
        RayCpmm(bool),
        ...
        BuyMintable(bool),
        UseMcap(bool),
        MinMasterBuy(Lamports),
        MaxMasterBuy(Lamports),
        UseLimitOrdersForBuys(bool),
        UseLimitOrdersForSells(bool),
        ReverseBuy(bool),
        ReverseSell(bool),
        AllowedBuys(u8),
        AllowedSells(u8),
        BuyNonce(UserNonceStrategy),
        SellNonce(UserNonceStrategy),
        SetWallet(Address),
    }
    ...
    #[derive(Clone, Debug, serde::Serialize, serde::Deserialize, Copy)]
    #[proto_message]
    pub struct SnipeTaskId(pub i64);
    ...
    pub enum SnipeUpdateField {
        BuyMode(bool),
        BuyAmount(SnipeBuyAmount),
        SellAmount(SnipeSellAmount),
        SellMode(bool),
        ConfigLimits(bool),
        LeftBuys(u8),
        TxnProcBuy(TxnProcessors),
        ...
        Devs(ConfigPubkeys),
        Mints(ConfigPubkeys),
        BlackList(ConfigPubkeys),
        BlacklistSwitch(bool),
        Name(::proto_rs::alloc::string::String),
        MinMcap(UD128),
        MaxMcap(UD128),
        UseLimitOrders(bool),
        LatestStateSlippage(bool),
        AllowMultipleActionsForMint(bool),
        AllowMultipleActionsForDev(bool),
        BuyAmountPerc(UD128),
        SellAmountPerc(UD128),
        BuyAmountFixed(QuoteLamports),
        SellAmountFixed(QuoteLamports),
    ...
    pub enum SwapAmount {
        Buy(QuoteLamports),
        BuyPerc { amount: UD128 },
        SellPerc { amount: UD128 },
        SellOut(QuoteLamports),
        SellInit,
    }
    ...
    pub struct TradeEventData {
        pub amount_base: SolanaLamports,
        pub amount_qoute: QuoteLamports,
        pub base_liq: SolanaLamports,
        pub quote_liq: QuoteLamports,
        pub pool_kind: DexType,
    }
    ...
    pub enum UserAction {
        ...
        TradeEvent(ConfirmState),
        OrderEvent(TokenLimitOrders),
        TokenTradeStats(TokenTradeState),
        Ping(Ping),
        Pong(Pong),
    }
